...
class hammingTables:
    def __init__(self, sizePar, data, paridad):
        ...
        self.tv2.column("col18", width=120, anchor=CENTER)
        self.tv2.column("col19", width=95, anchor=CENTER)
        ...
        self.tv2.heading("col17", text="D12", anchor=CENTER)  # 17
        self.tv2.heading("col18", text="Prueba de paridad",
                         anchor=CENTER)  # 16
        self.tv2.heading("col19", text="Bit de Paridad", anchor=CENTER)  # 17
        # Create Frame
